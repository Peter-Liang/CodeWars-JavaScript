'use strict';
let rainfall = require('../Solutions/rainfall.js');
let mean = rainfall.mean,
    variance = rainfall.variance;
require('should');

function assertFuzzyEquals(actual, expected) {
    const inrange = Math.abs(actual - expected) <= 1e-2;
    console.log(`actual: ${actual}, expected: ${expected}`);
    inrange.should.be.true(actual, expected);
}
